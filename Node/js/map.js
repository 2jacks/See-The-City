...
$('.add-form__button').on('click', (event) => {
    ...
    let pictureName = newPicture.imgUrl.replace("C:\\fakepath\\", '');
    console.log(pictureName);
    $('.gallery__content').append(createPictureItem(pictureName));
    $('.map').empty();
    ymaps.ready(init);
});

// let createPictureItem = function(name) {
//     return `
//             <div class="gallery__item">
//                 <div class="gallery__item-wrapper">
//                     <img class="gallery__img" src='img/uploads/${name}' alt="">
//                     <div class="gallery__info">
//                         <span class="gallery__place">1</span>
//                         <span class="gallery__author">1</span>
//                     </div>
//                 </div>
//             </div>
//     `;
